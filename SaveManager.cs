...
namespace MoreMountains.TopDownEngine
{
	...
	public virtual void SetCurrentScene(string scene) { SaveSettings.CurrentScene = scene; ResetGameSettings(); SaveGameSettings(); }
  public virtual void LoadSavedScene() { LoadGameSettings(); }
  public virtual string LoadSceneName() { return SaveSettings.CurrentScene; }

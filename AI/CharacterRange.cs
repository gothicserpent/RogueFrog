...
/// </summary>
[AddComponentMenu("TopDown Engine/Character/Abilities/Character Range")]
public class CharacterRange : CharacterAbility
{
...
public override void ProcessAbility()
{
	...
	SetPathedProjectileDestination();
	DeathAndLifeCycles();
}
...
protected void SetPathedProjectileDestination()
{
	//this.GetComponent<PathedProjectileSpawner>().Destination = GameObject.FindWithTag("Player").transform;
}
